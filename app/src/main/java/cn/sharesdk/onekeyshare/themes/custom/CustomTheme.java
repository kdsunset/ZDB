...
package cn.sharesdk.onekeyshare.themes.custom;
...
import cn.sharesdk.onekeyshare.themes.custom.port.CustomPlatformPagePort;

/** 九宫格经典主题样式的实现类*/
public class CustomTheme extends OnekeyShareThemeImpl {
	...
	protected void showPlatformPage(Context context) {
		...
		if (orientation == Configuration.ORIENTATION_PORTRAIT) {
			page = new CustomPlatformPagePort(this);
		} else {
			page = new CustomPlatformPagePort(this);
		}
	...
	/** 展示编辑界面*/
	public void showEditPage(Context context, Platform platform, ShareParams sp) {
		EditPage page;
		int orientation = context.getResources().getConfiguration().orientation;
		if (orientation == Configuration.ORIENTATION_PORTRAIT) {
