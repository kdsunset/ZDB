...
package cn.sharesdk.onekeyshare.themes.custom.port;
...
/** 竖屏的九宫格页面 */
public class CustomPlatformPagePort extends PlatformPage {

	public CustomPlatformPagePort(OnekeyShareThemeImpl impl) {
		super(impl);
	}
