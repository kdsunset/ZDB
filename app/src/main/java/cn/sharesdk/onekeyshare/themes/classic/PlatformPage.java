...
public abstract class PlatformPage extends OnekeySharePage {
	...
	public void onCreate() {
		...
		//vTop.setBackgroundColor(Color.GREEN);//
		...
		/* 修改 --by zin*/
		addCustomView(llPanel,animHide);
		...
		/*lp.setMargins(20, 40, 20, 40);
		vInd.setBackgroundColor(Color.CYAN);*/
	...
	protected abstract void addCustomView(LinearLayout llPanel,Animation animHide);
